...
public class ScheduleGamesNba extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private RecyclerView rv;
    private final String TAG = "schedule games NBA";
...
//        ScheduleGamesNba.fetchSchdule task = new fetchSchdule();
            ...
            if(scheduleModels!=null){
                ScheduleAdapter adapter = new ScheduleAdapter(scheduleModels, new ScheduleAdapter.ItemClickListener() {
                    ...
                    public void onItemClick(int clickedItemIndex) {
                        ...
                        Toast.makeText(ScheduleGamesNba.this,"Showing schedule for :"+date,Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(ScheduleGamesNba.this, ScheduleDetails.class);
