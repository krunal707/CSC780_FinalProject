...
public class nbaScheduleParse extends AsyncTask<Void, Void, Void> {

    String dataParsed = "";
    String singleParsed = "";
    String query = "teamstandingsentry";
    private  static  String TAG="nbaStandingsParse";
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://api.mysportsfeeds.com/v1.2/pull/nba/2017-2018-regular/overall_team_standings.json?teamstats=W,L,PTS,PTSA");
